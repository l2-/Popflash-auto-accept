...
// wake up service worker to handle icon change. 
// as it currently doesn't wake up on browser start leaving the icon in default state.
chrome.runtime.sendMessage({_ignore:"wakeup"});
